...
const Wallets = () => {
  ...
  const categories = [
    ...
    { id: 'long', label: 'Long', icon: 'fa-ruler-horizontal' },
    { id: 'cardholder', label: 'Card Holders', icon: 'fa-credit-card' }
  ];

  const filteredProducts = selectedCategory === 'all' 
    ? wallets 
    : wallets.filter(p => p.category === selectedCategory);
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-8 fade-in appear">
            <p className="text-gray-300 text-lg">
              <span className="text-[#D2C1B6] font-semibold">{filteredProducts.length}</span> premium wallets available
            </p>
          </div>
