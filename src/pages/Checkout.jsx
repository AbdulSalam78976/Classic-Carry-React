            ...
            <aside className="lg:col-span-1">
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl shadow-2xl p-6 md:p-8 sticky top-24 border border-gray-700">
                ...
                <button
                  ...
                  className="w-full bg-green-600 hover:bg-green-700 text-white px-5 py-4 rounded-xl font-bold flex items-center justify-center gap-3 shadow-2xl text-lg transition-all duration-300 hover:scale-105"
                >
