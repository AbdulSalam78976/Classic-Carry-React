...
import { caps } from '../data/products';
...
const Caps = () => {
  ...
  const categories = [
    ...
    { id: 'sports', label: 'Sports', icon: 'fa-running' }
  ];

  const filteredProducts = selectedCategory === 'all' 
    ? caps 
    : caps.filter(p => p.category === selectedCategory);
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-8 fade-in appear">
            <p className="text-gray-300 text-lg">
              <span className="text-[#D2C1B6] font-semibold">{filteredProducts.length}</span> premium caps available
            </p>
          </div>
