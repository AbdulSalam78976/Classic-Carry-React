...
const Users = () => {
  ...
  const fetchUserOrders = async (userId) => {
    ...
    try {
      ...
      const orders = response.data?.filter(order => order.user === userId || order.user?._id === userId) || [];
      ...
      <div className="bg-gray-800 rounded-xl border border-gray-700 p-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 rounded-lg bg-gray-700 text-gray-100 border-2 border-gray-600 focus:border-[#D2C1B6] focus:outline-none transition"
          />
          {searchTerm && (
            <button
            ...
            {!loadingOrders && userOrders.length > 0 && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="bg-purple-600/20 border border-purple-600/30 rounded-lg p-4">
                  ...
                  <p className="text-white text-2xl font-bold">
                    Rs {userOrders.reduce((sum, o) => sum + (o.totalAmount || 0), 0).toLocaleString()}
                  </p>
                </div>
              </div>
            )}
              ...
              {loadingOrders ? (
                ...
                <div className="space-y-3">
                  {userOrders.map((order) => (
                    <div key={order._id} className="bg-gray-700 rounded-lg p-4 hover:bg-gray-600 transition">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="text-right">
                          <p className="text-[#D2C1B6] font-bold">Rs {order.totalAmount?.toLocaleString()}</p>
