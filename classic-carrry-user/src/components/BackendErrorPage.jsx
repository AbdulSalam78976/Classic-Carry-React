    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center px-4 py-12">
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl text-primary mb-2" style={{ fontFamily: 'Satisfy, cursive' }}>dKart</h1>
            ...
            <div className="p-12">
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full bg-primary text-white px-6 py-4 rounded-xl font-semibold hover:bg-primary-dark transition shadow-lg hover:shadow-xl flex items-center justify-center gap-3"
                >
        ...
        <div className="text-center mt-8">
          <p className="text-gray-600">
            Need help? Contact us at <a href="mailto:dkart@gmail.com" className="text-primary hover:underline font-medium">dkart@gmail.com</a>
          </p>
        </div>
      </div>
    </div>
