        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-block">
            <div className="flex items-center justify-center gap-3 mb-2">
              <div className="w-10 h-10 bg-gradient-to-br from-[#8B7355] to-[#A68A6F] rounded-xl flex items-center justify-center shadow-lg">
          ...
          <p className="text-gray-600">Premium Accessories & Lifestyle</p>
        </div>
            ...
            <div className="p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input type="checkbox" className="w-4 h-4 text-[#8B7355] border-gray-300 rounded focus:ring-[#8B7355]" />
              ...
              <div className="relative my-8">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white text-gray-500">New to Classic Carrry?</span>
                </div>
              </div>
